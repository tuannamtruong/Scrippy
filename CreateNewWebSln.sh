...
dotnet new globaljson --sdk-version %sdkVer% --output $slnName/$projectName
dotnet new web --no-https --output $slnName/$projectName.Web --framework $frameworkVer
...
dotnet add $slnName/$projectName.Tests package Moq --version 
echo "Finish addinng libraries for test project"

# Create data provider project
dotnet new xunit -o $slnName/$projectName.DataProvider --framework $frameworkVer
